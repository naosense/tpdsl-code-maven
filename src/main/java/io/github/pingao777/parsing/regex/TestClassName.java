package io.github.pingao777.parsing.regex; /***
...
public class TestClassName {
    public static void main(String[] args) throws IOException {
        // match complete lines like "public clz TestClassName {"
        ...
        while ( line!=null ) {
            ...
            if ( m.matches() ) {          // did we find the line with name
                String name = m.group(2); // extract text after clz from regex
                System.out.println("clz name is "+name); // found it!
