...
public class Reduce extends TreeRewriter {
    ...
    public final bottomup_return bottomup() throws RecognitionException {
        ...
        xPlusx_return xPlusx1 = null;

        multBy2_return multBy22 = null;

        combineShifts_return combineShifts3 = null;
    ...
    public final xPlusx_return xPlusx() throws RecognitionException {
        xPlusx_return retval = new xPlusx_return();
        retval.start = input.LT(1);
    ...
    public final multBy2_return multBy2() throws RecognitionException {
        multBy2_return retval = new multBy2_return();
        retval.start = input.LT(1);
    ...
    public final combineShifts_return combineShifts() throws RecognitionException {
        combineShifts_return retval = new combineShifts_return();
        retval.start = input.LT(1);
