package io.github.pingao777.walking.patterns; /***
...
public class Simplify extends TreeRewriter {
    ...
    public final topdown_return topdown() throws RecognitionException {
        ...
        scalarVectorMult_return scalarVectorMult1 = null;
    ...
    public final bottomup_return bottomup() throws RecognitionException {
        bottomup_return retval = new bottomup_return();
        retval.start = input.LT(1);
        ...
        zeroX_return zeroX2 = null;

        xZero_return xZero3 = null;
    ...
    public final scalarVectorMult_return scalarVectorMult() throws RecognitionException {
        scalarVectorMult_return retval = new scalarVectorMult_return();
        retval.start = input.LT(1);
    ...
    public final zeroX_return zeroX() throws RecognitionException {
        zeroX_return retval = new zeroX_return();
        retval.start = input.LT(1);
    ...
    public final xZero_return xZero() throws RecognitionException {
        xZero_return retval = new xZero_return();
        retval.start = input.LT(1);
