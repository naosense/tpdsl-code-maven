package io.github.pingao777.walking.tree;// $ANTLR 3.2 Sep 23, 2009 12:02:23 D:/project/tpdsl-code/walking/tree-grammar/Printer.g 2019-08-11 12:53:51
...
public class Printer extends TreeParser {
    ...
    public String getGrammarFileName() { return "D:/project/tpdsl-code/walking/tree-grammar/Printer.g"; }

     void print(String s) { System.out.print(s); } 


    // $ANTLR start "prog"
    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:11:1: prog : ( stat )+ ;
    public final void prog() throws RecognitionException {
        try {
            // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:11:5: ( ( stat )+ )
            // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:11:9: ( stat )+
            {
            // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:11:9: ( stat )+
            int cnt1=0;
            loop1:
    ...
    // $ANTLR start "stat"
    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:13:1: stat : ( ^( '=' ID expr ) | ^( 'print' expr ) );
    public final void stat() throws RecognitionException {
        CommonTree ID1=null;

        try {
            // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:13:5: ( ^( '=' ID expr ) | ^( 'print' expr ) )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:13:9: ^( '=' ID expr )
                    {
                    ...
                    break;
                case 2 :
                    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:14:9: ^( 'print' expr )
                    {
    ...
    // $ANTLR start "expr"
    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:19:1: expr : ( ^( '+' expr expr ) | ^( '*' expr expr ) | ^( '.' expr expr ) | ^( VEC expr ( expr )* ) | INT | ID );
    public final void expr() throws RecognitionException {
        CommonTree INT2=null;
        CommonTree ID3=null;

        try {
            // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:19:5: ( ^( '+' expr expr ) | ^( '*' expr expr ) | ^( '.' expr expr ) | ^( VEC expr ( expr )* ) | INT | ID )
            int alt4=6;
            switch ( input.LA(1) ) {
            case 10:
                {
            ...
            switch (alt4) {
                case 1 :
                    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:19:9: ^( '+' expr expr )
                    {
                    ...
                    break;
                case 2 :
                    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:20:9: ^( '*' expr expr )
                    {
                    ...
                    break;
                case 3 :
                    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:21:9: ^( '.' expr expr )
                    {
                    ...
                    break;
                case 4 :
                    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:22:9: ^( VEC expr ( expr )* )
                    {
                    ...
                    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:22:34: ( expr )*
                    loop3:
                    do {
                        int alt3=2;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:22:35: expr
                    	    {
                    	    print(", ");
                    ...
                    break;
                case 5 :
                    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:23:9: INT
                    {
                    ...
                    break;
                case 6 :
                    // D:/project/tpdsl-code/walking/tree-grammar/Printer.g:24:9: ID
                    {
