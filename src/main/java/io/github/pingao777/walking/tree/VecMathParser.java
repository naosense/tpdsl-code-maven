package io.github.pingao777.walking.tree;// $ANTLR 3.2 Sep 23, 2009 12:02:23 D:/project/tpdsl-code/walking/tree-grammar/VecMath.g 2019-08-11 12:53:50
...
public class VecMathParser extends Parser {
    ...
    // $ANTLR start "prog"
    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:8:1: prog : ( stat )+ ;
    public final prog_return prog() throws RecognitionException {
        ...
        try {
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:8:5: ( ( stat )+ )
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:8:7: ( stat )+
            {
    ...
    // $ANTLR start "stat"
    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:9:1: stat : ( ID '=' expr -> ^( '=' ID expr ) | 'print' expr -> ^( 'print' expr ) );
    public final stat_return stat() throws RecognitionException {
        ...
        try {
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:9:5: ( ID '=' expr -> ^( '=' ID expr ) | 'print' expr -> ^( 'print' expr ) )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:9:7: ID '=' expr
                    {
                    ...
                    // 9:20: -> ^( '=' ID expr )
                    {
                        // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:9:23: ^( '=' ID expr )
                        {
                    ...
                    break;
                case 2 :
                    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:10:7: 'print' expr
                    {
                    ...
                    // 10:20: -> ^( 'print' expr )
                    {
                        // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:10:23: ^( 'print' expr )
                        {
                        Object root_1 = (Object)adaptor.nil();
    ...
    // $ANTLR start "expr"
    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:15:1: expr : multExpr ( '+' multExpr )* ;
    public final expr_return expr() throws RecognitionException {
        ...
        try {
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:15:5: ( multExpr ( '+' multExpr )* )
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:15:7: multExpr ( '+' multExpr )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:15:16: ( '+' multExpr )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:15:17: '+' multExpr
            	    {
    ...
    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:17:1: multExpr : primary ( ( '*' | '.' ) primary )* ;
    public final multExpr_return multExpr() throws RecognitionException {
        ...
        try {
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:18:5: ( primary ( ( '*' | '.' ) primary )* )
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:18:9: primary ( ( '*' | '.' ) primary )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:18:17: ( ( '*' | '.' ) primary )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:18:18: ( '*' | '.' ) primary
            	    {
            	    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:18:18: ( '*' | '.' )
            	    int alt4=2;
            	    ...
            	    switch (alt4) {
            	        case 1 :
            	            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:18:19: '*'
            	            {
            	            ...
            	            break;
            	        case 2 :
            	            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:18:24: '.'
            	            {
    ...
    // $ANTLR start "primary"
    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:21:1: primary : ( INT | ID | '[' expr ( ',' expr )* ']' -> ^( VEC ( expr )+ ) );
    public final primary_return primary() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_expr=new RewriteRuleSubtreeStream(adaptor,"rule expr");
        try {
            // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:22:5: ( INT | ID | '[' expr ( ',' expr )* ']' -> ^( VEC ( expr )+ ) )
            int alt7=3;
            switch ( input.LA(1) ) {
            case INT:
                {
            ...
            switch (alt7) {
                case 1 :
                    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:22:9: INT
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:23:9: ID
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:24:9: '[' expr ( ',' expr )* ']'
                    {
                    ...
                    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:24:18: ( ',' expr )*
                    loop6:
                    do {
                        int alt6=2;
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:24:19: ',' expr
                    	    {
                    ...
                    // 24:34: -> ^( VEC ( expr )+ )
                    {
                        // D:/project/tpdsl-code/walking/tree-grammar/VecMath.g:24:37: ^( VEC ( expr )+ )
                        {
                        Object root_1 = (Object)adaptor.nil();
